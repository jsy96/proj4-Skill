...
${colors.bright}3. Batch Transform Multiple Coordinates${colors.reset}
...
${colors.bright}4. Define Custom CRS${colors.reset}
...
${colors.bright}5. Get CRS Information${colors.reset}
   View the definition of a coordinate system:

   ${colors.cyan}node cli.js info EPSG:4326${colors.reset}

${colors.bright}6. List All Available CRS${colors.reset}
